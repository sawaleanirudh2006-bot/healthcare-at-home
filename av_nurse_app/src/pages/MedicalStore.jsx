...
const MedicalStore = () => {
        ...
        const fetchProducts = async () => {
            try {
                ...
                if (data && data.length > 0) {
                    ...
                    // Fallback default products if API empty
                    setProducts([
    ...
    if (loading) return <div className="flex justify-center items-center min-h-screen text-slate-500">Loading products...</div>;
